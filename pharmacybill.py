...
class billclass:
    def __init__(self,root,):
        ...
        self.cart_list=[]
        self.chk_print=0
        title=Label(self.root,text="Pharmacy Management System",font=("time new roman",40,"bold"),anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        pTitle=Label(productFrame1,text="ALL Medicine",font=("goudy old style",20,"bold"),bg="#262626",fg="white").pack(side=TOP,fill=X)
